...
var data1 =[ {
             ...
             "id" : "2",  
             "title": "1931年10月，我党我军第一个大型综合性兵工厂——中央兵工厂在（  ）诞生。",
	         "answer":"兴国官田",
             "xuanxiang":[
             				"于都桥头",
             				"赣县白鹭",
			...
			"id" : "4",
			"title": "1927年9月9日，秋收起义公开打出了我军的第一面旗帜，称为（）。",
			"answer":"工农革命军第一军第一师",
			"xuanxiang":[
							"工农革命军第一军第一师",
							"工农红军第一军第一师",
			...
			"id" : "5",
			"title": "1927年8月20日，秋收起义部队第三团进驻江西铜鼓后，在铜鼓县城南的武曲宫创办了第一个“新兵训练处”，具有我军历史上最早军校的雏形，时任“新兵训练处”主任的是（）。",
			"answer":"陈伯钧",
			"xuanxiang":[
							"宋任穷",
							"陈伯钧",
	...
	"id" : "8",
	"title": "方志敏在（）中描绘了祖国未来的美好幸福景象：“欢歌将代替了悲叹，笑脸将代替了哭脸，富裕将代替了贫穷，康健将代替了疾病，智慧将代替了愚昧，友爱将代替了仇恨，生之快乐将代替了死之忧伤，明媚的花园将代替了暗淡的荒地！”",
	"answer":"《可爱的中国》",
	"xuanxiang":[
		"《清贫》",
		"《狱中纪实》",
	...
	"id" : "9",
	"title": "江西萍乡市被誉为“中国傩文化之乡”，其中被公认为的“三宝”是（）。",
	"answer":"傩庙、傩面具、傩舞",
	"xuanxiang":[
		"傩庙、傩面具、傩舞",
		"傩庙、傩面具、傩戏",
	...
	"id" : "10",
	"title": "近年来，江西省把社会主义核心价值观同江西改革发展实践紧密结合，以诚信建设和法治建设为突破口，针对道德领域突出问题和法院执行难问题，推动本省（）共同建立“法媒银·失信被执行人曝光台”。",
	"answer":"以上全是",
	"xuanxiang":[
		"法院",
		"媒体",
	...
	"id" : "11",
	"title": "1973年江西发现的（）遗址，打破了“商文化不过长江”的论断。",
	"answer":"吴城遗址",
	"xuanxiang":[
		"筑卫城遗址",
		"樊城堆遗址",
	...
	"id" : "12",
	"title": "江西省樟树市是“中国药都”，素有“药不到樟树不齐，药不过樟树不灵”之美誉。樟树吴茱萸是该市道地药材、国家地理标志保护产品，本地俗称吴萸子，为（）科植物吴茱萸的未成熟果实。",
	"answer":"芸香",
	"xuanxiang":[
		"蔷薇",
		"芸香",
	...
	"id" : "14",
	"title": "2011年，铅山（）生产基地入围文化部设立的首批国家级非物质文化遗产生产性保护示范基地。",
	"answer":"连四纸",
	"xuanxiang":[
		"宣纸",
		"薛涛笺",
	...
	"id" : "15",
	"title": "（）荣获“最多跆拳道女子金牌（轻量级选手）”吉尼斯世界纪录称号。",
	"answer":"吴静钰",
	"xuanxiang":[
		"陈中",
		"吴静钰",
